...
# RENDER_TO_EXIST=1: the render loss also trains per-organ existence (default: loss_phytomer_exist BCE only).
if [ "${RENDER_TO_EXIST:-0}" = "1" ]; then
    STAGE3_ARGS="${STAGE3_ARGS} --render_to_exist"
fi
