...
# rotation-residual -- see plant_recon/models/phytomer_vae.py docstring).
...
mkdir -p "${REPO_ROOT}/plant_recon/checkpoints/phytomer_vae"
cd ${REPO_ROOT}
...
${PYTHON_BIN} plant_recon/training/train_phytomer_vae.py \
    ...
    --checkpoint-dir "${CHECKPOINT_DIR:-plant_recon/checkpoints/phytomer_vae_v8}" \
