...
def main():
    ...
    ckpt_path = os.path.join(REPO_ROOT, "plant_recon/checkpoints/fm/part_flow_matching_scaffold_epoch50.pt")
    if not os.path.exists(ckpt_path):
        ckpt_path = os.path.join(REPO_ROOT, "plant_recon/checkpoints/fm/part_flow_matching_scaffold.pt")
    if not os.path.exists(ckpt_path):
