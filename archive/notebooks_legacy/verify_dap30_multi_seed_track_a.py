...
from plant_recon.models.legacy.helios_geometry_track_a import build_helios_geometry_from_xml, HeliosPlantGeometryTorch, DifferentiableHeliosXMLRenderer
...
def generate_gt_sample_for_seed(output_dir: str, dap: int = 30, seed: int = 42) -> dict:
...
def verify_seed(seed: int, output_dir: str, device: torch.device, rasterizer: HeliosGeometryRasterizer):
    ...
    print(f"\n--- Testing Seed {seed} ---")
    gt_info = generate_gt_sample_for_seed(output_dir=output_dir, dap=30, seed=seed)
    ...
    # Save main file if seed==42 to update dap30_3way_comparison.png
    if seed == 42:
        main_fig_path = os.path.join(output_dir, "dap30_3way_comparison.png")
...
def main():
    ...
    results = []
    print("=======================================================")
    print(f"STARTING MULTI-SEED DAP 30 RENDERER VERIFICATION ({len(seeds)} seeds)")
    print(f"Seeds: {seeds}")
    print("=======================================================")
    ...
    print("\n=========================================================================")
    print("MULTI-SEED DAP 30 RENDERER VERIFICATION (XML vs PyTorch Diff on Black BG)")
    print("=========================================================================")
