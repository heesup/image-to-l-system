...
def main():
    ...
    # 2. Render 15D nodes parsed from DAP 30 GT XML via PyTorch Differentiable Renderer
    ...
    print("\n=======================================================")
    print("DAP 30 PLANT: HELIOS C++ RENDER vs 15D TORCH RENDER COMPARISON")
    print("=======================================================")
    ...
    plt.tight_layout()
    comp_fig_path = os.path.join(output_dir, "dap30_helios_vs_torch_comparison.png")
    plt.savefig(comp_fig_path, dpi=200, bbox_inches="tight")
    plt.close()
    print(f"[PASS] Saved DAP 30 comparison figure to: {comp_fig_path}")
