...
Framing matches diffusion_based/dataset/generate_cache.py exactly:
...
Helios ignores a params entry's (x, y) for an XML-loaded plant (see real_world/eval/run_multiplant_scene.py),
...
from diffusion_based.dataset.part_array_dataset import PartArrayDataset  # noqa: E402
from diffusion_based.models.helios_pytorch_renderer import HeliosPyTorchRenderer  # noqa: E402
from diffusion_based.models.plant_organ_array import PlantOrganArray  # noqa: E402

HELIOS_ROOT = REPO / "Digital-Crops" / "projects" / "syntheticdata_generation"
