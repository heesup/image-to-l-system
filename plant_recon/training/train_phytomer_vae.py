...
Usage (workspace root):
    /home/lion397/.conda/envs/digital-crops/bin/python \\
        plant_recon/training/train_phytomer_vae.py \\
...
from plant_recon.dataset.phytomer_packets import build_phytomer_packets, strip_base
...
def main():
    ...
    parser.add_argument("--checkpoint-dir", type=str,
                        default="outputs/checkpoints/phytomer_vae")
