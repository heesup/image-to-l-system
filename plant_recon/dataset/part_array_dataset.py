...
from plant_recon.models.plant_organ_array import (  # noqa: E402,F401
    ORGAN_BUD,
    ORGAN_FLOWER,
)
...
def attach_parent_links(pkt: Dict[str, torch.Tensor]) -> None:
    ...
    if not isinstance(pkt, dict) or "keys" not in pkt or "parent_pos" in pkt:
        return
    from plant_recon.dataset.phytomer_packets import (   # local: phytomer_packets imports this module
