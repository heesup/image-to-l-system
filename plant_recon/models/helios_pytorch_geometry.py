...
ASSET_DIR = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "..", "submodules/Digital-Crops", "libs", "Helios", "plugins", "plantarchitecture", "assets", "obj")
)
...
TEXTURE_DIR = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "..", "submodules/Digital-Crops", "libs", "Helios", "plugins", "plantarchitecture", "assets", "textures")
)
...
def diff_node_to_part_tensor_14d(
    ...
    """
    from plant_recon.models.plant_organ_array import ORGAN_NONE
