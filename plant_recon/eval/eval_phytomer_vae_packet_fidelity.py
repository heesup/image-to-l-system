...
from plant_recon.models.plant_organ_array import PlantOrganArray, ORGAN_NONE, P_COL_ORGAN_TYPE
from plant_recon.models.phytomer_vae import PhytomerVAE
from plant_recon.dataset.part_array_dataset import encode_fm, FM_NODE_DIM
...
from plant_recon.eval.eval_13d_xml_organ_masks import TEST_PLANTS

DEVICE = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
DEFAULT_VAE_CHECKPOINT = os.path.join(
    REPO_ROOT, "outputs/checkpoints/phytomer_vae_v9_tl_rw4_20k/phytomer_vae_128d_best.pt")
