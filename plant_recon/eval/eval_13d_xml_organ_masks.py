...
TEST_PLANTS = [
    ("DAP 10 (Seedling)", "submodules/Digital-Crops/projects/syntheticdata_generation/build/output/exact_gt_renders/rad_dap010_0000_plant_0000.xml", "dap010"),
    ("DAP 50 (Branching)", "submodules/Digital-Crops/projects/syntheticdata_generation/build/output/exact_gt_renders/rad_dap050_0000_plant_0000.xml", "dap050"),
    ("DAP 90 (Fruiting)", "submodules/Digital-Crops/projects/syntheticdata_generation/build/output/exact_gt_renders/rad_dap090_0000_plant_0000.xml", "dap090"),
]
...
def render_helios_full(xml_path: str, name_prefix: str, species: str = "cowpea") -> Dict[str, Any]:
    ...
    cfg_file = os.path.join(REPO_ROOT, f"submodules/Digital-Crops/projects/syntheticdata_generation/configs/params_{species}.json")
