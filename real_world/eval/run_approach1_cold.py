...
diffusion_based/eval/eval_test_time_refinement.py (lines 62-110) exactly, minus everything
...
from diffusion_based.models.hierarchical_part_flow_matching import HierarchicalPartFlowMatchingModel, reconstruct_phytomer_rot, compute_matryoshka_slice
...
def main():
    ...
    ap.add_argument("--detector_weights", default=str(REPO_ROOT / "slurm_scripts/logs/20260915/real_plant_detector/weights/best.pt"))
    ...
    ap.add_argument("--out", default=str(REPO_ROOT / "real_world/eval/output/approach1_cold"))
    a = ap.parse_args()
