...
proven on synthetic inputs in diffusion_based/eval/eval_test_time_refinement.py, extended here
...
test-time refinement):
  ...
  - --scale_clip_mult (hard multiplicative bound on scale, default 1.5) and --reg_pos (quadratic
    ...
    (diffusion_based/dataset/phytomer_packets.py) multiplies every organ in a phytomer's packet
...
def main():
    ...
    ap.add_argument("--out", default=str(REPO_ROOT / "real_world/eval/output/approach2_refine"))
    a = ap.parse_args()
