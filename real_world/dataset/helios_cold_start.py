...
_HELIOS_ROOT = REPO_ROOT / "Digital-Crops" / "projects" / "syntheticdata_generation"
...
def helios_state_from_xml(xml_path: Path, pvae, device: torch.device, M: int = 10):
    ...
    The conversion chain is the training set's own (diffusion_based/dataset/generate_cache.py,
    ...
    from diffusion_based.dataset.generate_cache import build_pkt_targets, extract_phytomer_ids
