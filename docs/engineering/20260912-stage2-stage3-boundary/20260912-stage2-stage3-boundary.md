---
title: "Session Handoff: Gradient Explosion Root-Caused to the Learning Rate, Stage 2/3 Boundary Redesign Underway"
date: 2026-09-12
...
1. **`docs/../../agent-handover-guide/agent-handover-guide.md`** -- general orientation (environment, how to launch jobs locally vs SLURM, established conventions).
