---
title: "Differentiable Renderer vs Helios Visual Alignment Debug"
date: 2026-08-15
...
> **Render Output**: Generated to `/tmp/helios_render_test/compare/renders.png` during alignment evaluation.
...
> **Render Output**: Generated to `/tmp/helios_render_test/compare/background_comparison.png`.

### 4.3 Per-pixel absolute difference maps

> **Render Output**: Generated to `/tmp/helios_render_test/compare/diff_maps.png`.

### 4.4 Plant masks and IoU

> **Render Output**: Generated to `/tmp/helios_render_test/compare/mask_metrics.png`.

### 4.5 Multi-view stability (azimuth 0°, 45°, 90°, 135°)

> **Render Output**: Generated to `/tmp/helios_render_test/azimuth_grid.png`.
