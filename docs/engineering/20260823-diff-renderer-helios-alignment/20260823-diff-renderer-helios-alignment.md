---
title: "Image-to-L-System: Differentiable Renderer Alignment, COCO Internode Masking & Lossless XML Round-Trip Report"
date: 2026-08-23
...
![Helios XML vs PyTorch Differentiable Renderer Alignment](assets/fig_helios_xml_vs_differentiable_render_alignment.png)
...
| File | Purpose |
| :--- | :--- |
| `render_xml/main.cpp` | Lightweight standalone Helios C++ Visualizer binary for quick XML-to-image rendering (headless OpenGL) |
| `render_xml/CMakeLists.txt` | CMake build config for `render_xml` project |
| [`archive/scratch/evaluate_xml_roundtrip_metrics.py`](../../../archive/scratch/evaluate_xml_roundtrip_metrics.py) | 100-sample XML round-trip benchmark script (text match + numeric parameter error + 3D vertex deviation) |
