---
title: "20260830-pr-xml-roundtrip-fix"
date: 2026-08-30
...
Script: [`tests/unit/helios_xml_roundtrip_visualizer.py`](../../../tests/unit/helios_xml_roundtrip_visualizer.py)
...
![2-row Helios Visualizer comparison. Top (BEFORE fix): Stage 2 shows extreme leaf inflation (MAE=0.3236). Bottom (AFTER fix): all three stages are pixel-identical (MAE=0.0000).](assets/fig_helios_xml_roundtrip_vis_stages.png)
...
![Python PyTorch renderer — original (left) vs reloaded XML (center) vs pixel diff (right). Row 1: Helios C++ raytrace. Row 2: PyTorch renderer.](assets/helios_python_true_roundtrip_comparison.png)
