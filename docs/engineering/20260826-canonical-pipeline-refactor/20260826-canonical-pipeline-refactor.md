---
title: "Canonical Pipeline Refactor: XML → 40D → 16D → Part Render (Implementation Progress)"
date: 2026-08-26
...
**Context**: Executed the [`20260826_implementation_plan.md`](../20260826-implementation-plan/20260826-implementation-plan.md) — unified every rendering path onto the single canonical path below and fully removed the legacy 94D layout from the rendering pipeline.
...
> plants) is tracked in [`20260831_27d_fm_layout_and_shard_regeneration.md`](../20260831-27d-fm-layout-shard-regen/20260831-27d-fm-layout-shard-regen.md) §8.
