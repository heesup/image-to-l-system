...
**Folder conventions:**
- `docs/handovers/` — live status dashboard (this file), session handoffs, and takeover guide
- `docs/architecture/` — architectural design documents, ADRs, specs, and the code-structure map
...
- `docs/planning/` — roadmaps & upcoming milestone plans
- `docs/archive/` — archived and superseded documentation
- `docs/_index.md` — the documentation map of content (MOC) indexing all of the above
