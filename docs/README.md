...
**Active Checkpoints**: `diffusion_based/checkpoints/phytomer_vae_v9_tl_rw4_20k/phytomer_vae_128d_best.pt` (VAE) and `diffusion_based/checkpoints/hierarchical_fm_v9/` (FM, job 38253029 resumed at epoch 16 on the vectorized assembly; see `ongoing/README.md`).
