---
title: "Project Roadmap — 26D VLM-Scaffold-DiT Flow Matching"
date: unknown
...
- [ ] **Accelerate XML Deserialization & Forward Kinematics Pipeline** (Reduce 3.8s DAP 100 E2E bottleneck to <100ms via shoot-level chunked assembly / vectorized FK; see [`task_speedup_xml_loading_and_kinematics.md`](task-speedup-xml-kinematics.md))
