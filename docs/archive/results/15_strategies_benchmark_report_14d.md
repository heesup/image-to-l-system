...
![Figure 1: Helios vs PyTorch Rendering Benchmark](../../experiments/15-strategies-benchmark/assets/fig1_helios_vs_torch_rendering_benchmark.png)
...
![Figure 2: 14D Part Renderer Identity Comparison](../../experiments/15-strategies-benchmark/assets/fig2_14d_part_renderer_identity_comparison.png)

---

### Figure 3: Direct Optimization Multi-DAP Panel (mSSIM + FG-IoU)
![Figure 3: Direct Optimization](../../experiments/15-strategies-benchmark/assets/fig3_direct_opt_multi_dap.png)

---

### Figure 4–7: ViT TTA, Diffusion, Convergence & Canopy Metrics
![Figure 4: ViT TTA](../../experiments/15-strategies-benchmark/assets/fig4_vit_decoder_tta_breakthrough.png)
![Figure 5: Diffusion Generative](../../experiments/15-strategies-benchmark/assets/fig5_vit_diffusion_generative.png)
![Figure 6: Loss Convergence](../../experiments/15-strategies-benchmark/assets/fig6_loss_convergence_trajectories.png)
![Figure 7: Canopy Metrics](../../experiments/15-strategies-benchmark/assets/fig7_botanical_3d_canopy_metrics.png)
...
![Figure 8: Multi-Modal Render Outputs](../../experiments/15-strategies-benchmark/assets/fig8_multimodal_depth_mask.png)
