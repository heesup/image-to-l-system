...
| :--- | :--- | :--- |
| **[20260908_cascaded_architecture_design_space_analysis.md](file:///home/lion397/codes/image-to-l-system/docs/ongoing/20260908_cascaded_architecture_design_space_analysis.md)** | **Cascaded Architecture Design Space: Deterministic vs. Diffusion Analysis (ADR)** | Evaluation of $2 \times 2 = 4$ architectural combinations (Stage 2 scaffold vs Stage 3 organs). Mathematical proof of why [Det + Diff] is the optimal trade-off between metric 3D accuracy, organic leaf realism, and DepthAnything compatibility. |
