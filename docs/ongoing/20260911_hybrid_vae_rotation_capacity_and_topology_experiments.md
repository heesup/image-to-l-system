...
- **Supersedes**: [`20260911_takeover_grad_norm_fix_roundtrip_diagnosis_10slot_restore.md`](20260911_takeover_grad_norm_fix_roundtrip_diagnosis_10slot_restore.md) for the PhytomerVAE checkpoint lineage (that doc's "MUST be retrained from scratch" instruction is now satisfied by v8 below)
