...
variants: w3t0 ep85 34.4, lr 2e-4 ep100 33.0 — every training-side variant sits at 33–35. First reading of `sub10_v10_cam` at ep80: strict P **35.8** (v10 itself was 35.4 at ep80) — within noise so far; ep85/90/95 readings are queued automatically (background loop that waits for each checkpoint).
