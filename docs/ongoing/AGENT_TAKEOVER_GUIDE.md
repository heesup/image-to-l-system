...
a detached loop scores its EMA files ep130–160 (`full_ema_readings2.log` in the session scratchpad). ep130 EMA: 37.5, refined 66.0; ep135 EMA: 35.9, refined 64.9.
