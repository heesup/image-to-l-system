...
5. **Curvature in FM (IN PROGRESS 2026-09-04)**: the FM node layout was 25D (`FM_NODE_DIM=25`) and **did not encode curvature** (14D col 13). Completed so far:
   ...
   - Remaining: full 50-epoch training on SLURM (`slurm_scripts/train_part_fm_curv.sh`) once a GPU slot is allocated; cluster queue was congested (314+ running jobs).
