...
gt_nodes 46–48 mean 33.3 (3 epochs; baseline 46–48 mean 31.7). No clear separation yet under the in-training protocol; the gt_nodes arm is the only one above the baseline's band so far, and its Vel falls steadily (0.169 → 0.154). Under the ablation protocol
